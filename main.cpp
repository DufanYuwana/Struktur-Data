...
{   
    ...
    do{
        ...
        cout << "2. Finish antrian" << endl;
        cout << "3. Display antrian" << endl;
        cout << "4. Check antrian" << endl;
        cout << "5. Exit" << endl;
        cout << "\n\n\n";
        cout << "Menu pilihan : ";cin>>opsi;
        

        switch (opsi)
        {
        case 1:
            cout << "Mengisikan nomor antrian ";cin>>angka;
            enqueue(angka);
            cout << "\n\n\n";
            break;
        case 2:
        ...
        case 3:
            if (isEmpty()!=true)
            {
                cout << "Kuota yang tersedia ";tampil();
                cout << "\n\n";
            }
            else{
